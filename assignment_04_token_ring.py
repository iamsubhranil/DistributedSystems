...
def main():
    ...
    network = [Node(0, manager, global_queue, global_lock, global_watch, num_nodes)]  # adding first node in the network
    # adding the rest of the nodes in the network
    for i in range(num_nodes - 1):
        network.append(Node(i+1, manager, global_queue, global_lock, global_watch, num_nodes))
